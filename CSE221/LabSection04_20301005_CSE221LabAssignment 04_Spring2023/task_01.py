...
def readFile():
    ...
    f = open("/content/drive/MyDrive/221Lab_INPUT OUTPUT/Lab_04/graph.txt", "r")
...
def buildGraphUsingListofLists(c,f):
    ...
    for i in range(n):
      listGraph.append([0])
      for j in range(c-1):
        listGraph[i].append(0)
    for i in range(1,c+1):
      idx = lines[i - 1][0]
      listGraph[idx - 1][lines[i-1][1]-1]= 1
    return listGraph
...
graph = buildGraphUsingListofLists(n, c)
