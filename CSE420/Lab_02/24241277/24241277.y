...
%token IF ELSE FOR WHILE DO BREAK CONTINUE RETURN INT FLOAT CHAR VOID DOUBLE ASSIGNOP SWITCH CASE DEFAULT PRINTLN NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA ADDOP MULOP INCOP DECOP RELOP LOGICOP ID CONST_INT CONST_FLOAT GOTO
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("24241277.txt", ios::trunc);
